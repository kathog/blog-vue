              ...
              <div class="row">
                <div class="section-row">
                  ...
                  <ul class="contact">
                    ...
                    <li><i class="fa fa-envelope"></i> <a href="mailto:daniel.lewinski@craftsoft.eu">daniel.lewinski@craftsoft.eu</a></li>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <input class="input" v-bind:disabled="disabled" type="email" placeholder="E-mail" v-model="email" required>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          <textarea class="input" v-bind:disabled="disabled" v-model="message" placeholder="Wiadomość" required></textarea>
                        </div>
...
axios.get("/last")
    ...
    methods: {
      ...
      doSend: function (event) {
        this.disabled = true;
        let msg = "{\"email\": \""+ this.email + "\", \"message\": \"" + this.message + "\"}";
